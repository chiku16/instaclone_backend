...
//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

const transporter = nodemailer.createTransport(sendgridTransport({
    auth:{
        api_key:"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"
    }
}))
...
router.post('/new-password',(req,res)=>{
    ...
    const sentToken = req.body.token1
